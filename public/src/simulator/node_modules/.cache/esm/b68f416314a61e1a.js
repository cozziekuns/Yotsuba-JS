let ConfigurationUtil,ConfigurationNode,GameStateNode;_14a‍.x([["Simulator",()=>Simulator],["SimulationAdapter",()=>SimulationAdapter]]);_14a‍.w("./util.js",[["ConfigurationUtil",["ConfigurationUtil"],function(v){ConfigurationUtil=v}]]);_14a‍.w("./nodes.js",[["ConfigurationNode",["ConfigurationNode"],function(v){ConfigurationNode=v}],["GameStateNode",["GameStateNode"],function(v){GameStateNode=v}]]);/* TODO List:
  - Customizable Dora
  - Chiitoi and Kokushi
  - Aka Nashi
*/
...
//=============================================================================
  ...
  simulateHitori(playerIndex, drawsLeft, endShanten) {
    ...
    if (playerIndex === 3) {
      _14a‍.g.console.log(this.wallTiles);
      _14a‍.g.console.log(drawsLeft);
    }
